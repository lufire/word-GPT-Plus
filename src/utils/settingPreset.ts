...
export const settingPreset = {
  ...
  officialModelSelect: selectSetting('gpt-4o-mini', 'model', availableModels),
  ...
  geminiModelSelect: selectSetting('gemini-2.5-flash', 'geminiModel', availableModelsForGemini),
